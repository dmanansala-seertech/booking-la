...
class ViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.title = selected_carrier_name
        tableView.register(UINib(nibName: "FlightTableViewCell", bundle: nil), forCellReuseIdentifier: "cell_todo")
    }
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        print("http://52.221.214.215/flights/?carrier=\(String(describing: selected_carrier_id!))")
        if let urlComponents = URLComponents(string: "http://52.221.214.215/flights/?carrier=\(String(describing: selected_carrier_id!))") {
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell_todo", for: indexPath) as! FlightTableViewCell
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCellEditingStyle, forRowAt indexPath: IndexPath)
    {
        if indexPath.row < todoItems.count
        {
            ...
            confirmation.addAction(UIAlertAction(title: "OK", style: .default, handler: { (_) in
                ...
                if let urlComponents = URLComponents(string: "http://52.221.214.215/flights/\(String(describing: item_id))/") {
                    guard let url = urlComponents.url else { return }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "add_flight_segue" {
